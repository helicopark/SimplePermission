...
internal class CommonPermissionActivity : PermissionActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        if (isMarshMallow()) {
            ...
            LocalBroadcastManager.getInstance(this@CommonPermissionActivity).sendBroadcast(
    ...
    override fun onRequestPermissionsResult(requestCode: Int, permissions: Array<out String>, grantResults: IntArray) {
        ...
        LocalBroadcastManager.getInstance(this@CommonPermissionActivity).sendBroadcast(permissionResultIntent)
        finish()
    }
}